...
class EnrichstorySpiderMiddleware:
...
class EnrichstoryDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
class TorProxyMiddleware:
    def __init__(self, settings):
        self.tor_controller_port = settings.get('TOR_CONTROLLER_PORT', 9051)
    ...
    def new_identity(self):
        """Solicita uma nova identidade do Tor"""
