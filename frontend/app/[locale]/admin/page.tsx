  ...
  return (
    <div className="flex-1 space-y-4 p-8 pt-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              +{adminStats?.newUsersThisMonth || 0} {t('thisMonth')}
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">{t('requests24h')}</CardTitle>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">{t('activeEndpoints')}</CardTitle>
      ...
      <Card>
        <CardHeader>
          <CardTitle>{t('privateEndpoints')}</CardTitle>
          <CardDescription>
